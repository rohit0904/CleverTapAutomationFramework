...
public class TestListeners implements ITestListener {
    ...
    public void onTestStart(ITestResult iTestResult) {
        test = extent.createTest(iTestResult.getTestClass().getName()+" :: "+iTestResult.getMethod().getDescription());
        extentTest.set(test);
    }
    ...
    public void onTestFailure(ITestResult iTestResult) {
       ...
       // extentTest.get().fail("Exception Occured, click to see details:"+exceptionMessage.replaceAll(",","<br>"));
        ...
        try {
            ...
            extentTest.get().fail((Markup) extentTest.get().addScreenCaptureFromBase64String(encodedString,"Click"));
        }catch (Exception e){
